...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed z-[100] flex max-h-screen w-full flex-col gap-2 p-5 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col sm:max-w-[360px]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "shrink-0 mt-0.5 rounded-full p-1 text-muted-foreground/40 opacity-0 transition-opacity duration-200 hover:text-foreground focus:opacity-100 focus:outline-none group-hover:opacity-100",
      className
    )}
    toast-close=""
    {...props}
